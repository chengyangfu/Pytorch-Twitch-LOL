...
parser.add_argument('--train_data_path', dest='train_data_path', help='Directory contains the training images', default='/net/bvisionserver3/playpen10/cyfu/twitch_lol/', type=str, metavar='PATH')

parser.add_argument('--train_annFile', dest='train_ann', help='List file contains location of images and labels', default='/net/bvisionserver3/playpen10/cyfu/twitch_lol/nalcs_train.txt', type=str, metavar='PATH')

parser.add_argument('--val_annFile', dest='val_ann', help='List file contains location of images and labels', default='/net/bvisionserver3/playpen10/cyfu/twitch_lol/nalcs_val.txt', type=str, metavar='PATH')
...
parser.add_argument('--save-dir', dest='save_dir', help='The directory used to save the trained models', default='save_models', type=str)
...
parser.add_argument('--multi-frame', default=1, type=int,
                    metavar='N', help='Multi Frame (for LSTM on CNN) (default: 1)')
...
def main():
    ...
    print ('=> Setting:')
    for it in vars(parser.parse_args()).iteritems():
        print(it)
    ...
    trainLoader = Twitch(root=args.train_data_path, list_file=args.train_ann, 
            transform=transforms.Compose([
               # transforms.Scale((224,224)),
                transforms.ToTensor(), 
                normalize,
                ]), prod_Img = not (args.noImg), multi_frame=args.multi_frame, text_window =args.text_window, gt_range=args.gt_range, word=args.word)
